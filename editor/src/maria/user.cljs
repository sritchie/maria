(ns maria.user
  ...
  (:require chia.view.hiccup
            ...
            goog.net.jsloader
            ;; solely for `stringToUtf8ByteArray` in Shannon's
            ;; Entropy lesson -- feel free to remove once we switch
            ;; to a simple story for grabbing a single external
            ;; dependency
            goog.crypt
            maria.user.loaders
            maria.repl-specials
            [cells.cell :as cell :refer [defcell cell with-view]]
            [cells.lib :refer [interval timeout fetch geo-location]]
            [shapes.core :as shapes :refer [listen
                                            circle ellipse
                                            ;; square
                                            rectangle triangle polygon polyline text image
            ...
            #_[sicmutils.env :as e :refer [->infix
                                           elliptic-f
                                           Hamiltonian
